...
if (FuelTotalRenderMini == true) {
        ...
        FuelIntervalMini = setInterval(()=> getTimelineData(totalFuelMini, "-2d", "20m"), 300000)

        document.getElementById('btn1FuelMini').addEventListener('click', function () {
            clearInterval(FuelIntervalMini)
            updateButtonClass(this);
            getTimelineData(totalFuelMini, "-12h", "5m");
            FuelIntervalMini = setInterval(()=> getTimelineData(totalFuelMini, "-12h", "5m"), 300000)
        });
    
        document.getElementById('btn2FuelMini').addEventListener('click', function () {
            clearInterval(FuelIntervalMini)
            updateButtonClass(this);
            getTimelineData(totalFuelMini, "-24h", "10m");
            FuelIntervalMini = setInterval(()=> getTimelineData(tottotalFuelMiniatotalFuelMinilFuel, "-24h", "10m"), 300000)
        });
    
        document.getElementById('btn3FuelMini').addEventListener('click', function () {
            clearInterval(FuelIntervalMini)
            updateButtonClass(this);
            getTimelineData(totalFuelMini, "-2d", "20m");
            FuelIntervalMini = setInterval(()=> getTimelineData(totalFuelMini, "-2d", "20m"), 600000)
        });
    
        document.getElementById('btn4FuelMini').addEventListener('click', function () {
            clearInterval(FuelIntervalMini)
            updateButtonClass(this);
            getTimelineData(totalFuelMini, "-3d", "30m");
            FuelIntervalMini = setInterval(()=> getTimelineData(totalFuelMini, "-3d", "30m"), 600000)
        });
