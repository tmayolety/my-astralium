components.singleLineHeader = {
  ...
  updated() {
    ...
    if (parseFloat(this.valueOneAnalogue) >= parseFloat(this.HH)) {
      result.HH = true;
    }
    if (
      parseFloat(this.valueOneAnalogue) >= parseFloat(this.H) &&
      (parseFloat(this.valueOneAnalogue) < parseFloat(this.HH) ||
        this.HH == null)
    ) {
      result.H = true;
    }
    if (
      parseFloat(this.valueOneAnalogue) <= parseFloat(this.L) &&
      (parseFloat(this.valueOneAnalogue) > parseFloat(this.LL) ||
        this.LL == null)
    ) {
      result.L = true;
    }
    if (parseFloat(this.valueOneAnalogue) <= parseFloat(this.LL)) {
      result.LL = true;
    }
    if (parseFloat(this.valueTwoAnalogue) >= parseFloat(this.HH)) {
      result.HH = true;
    }
    if (
      parseFloat(this.valueTwoAnalogue) >= parseFloat(this.H) &&
      (parseFloat(this.valueTwoAnalogue) < parseFloat(this.HH) ||
        this.HH == null)
    ) {
      result.H = true;
    }
    if (
      parseFloat(this.valueTwoAnalogue) <= parseFloat(this.L) &&
      (parseFloat(this.valueTwoAnalogue) > parseFloat(this.LL) ||
        this.LL == null)
    ) {
      result.L = true;
    }
    if (parseFloat(this.valueTwoAnalogue) <= parseFloat(this.LL)) {
      result.LL = true;
    }
